...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [RouterLink , CarouselModule , TranslateModule , HeartclickDirective , CurrencyPipe , FormsModule , SearchPipe , TexttermPipe , JsonPipe , DatePipe , LowerCasePipe , UpperCasePipe],
